...
SAVE_DIR="/data/yingting/libritts/libritts_save_dir_vctk_2e6_finetune_updatefreq1"

rm -rf /data/yingting/libritts/libritts_save_dir_vctk_2e6_finetune_updatefreq1/*
...
CUDA_VISIBLE_DEVICES=1 python tts.py ${FEATURE_MANIFEST_ROOT} --save-dir ${SAVE_DIR} \
  ...
  --optimizer adam --lr 2e-6 --lr-scheduler inverse_sqrt --warmup-updates 4000 \
