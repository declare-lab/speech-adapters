...
def main(cfg: FairseqConfig) -> None:
	...
	# # print(vctk_cfg.task)
	# count = 0
	# for key, value in vctk_cfg.task.__dict__.items():
	# 	try:
	# 		cfg_value = cfg.task.__dict__[key]

	# 		if cfg_value != value:
	# 			print(key, value, cfg_value)
	# 			count += 1
	# 	except KeyError:
	...
	del pretrained_dict["encoder.spk_emb_proj.weight"]
	del pretrained_dict["encoder.spk_emb_proj.bias"]
