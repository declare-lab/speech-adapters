...
AUDIO_DATA_ROOT="/data/yingting/libritts"
...
### 1.modify 'uer_cer' to 'uer_char', add '/asr', should be right 2. delete le --ipa-vocab
python get_feature_manifest.py \
	--audio-manifest-root ${PROCESSED_DATA_ROOT} \
	--output-root ${FEATURE_MANIFEST_ROOT} \
	--use-g2p \
	--cer-tsv-path ${EVAL_OUTPUT_ROOT}/asr/uer_char.tsv  \
	# --snr-threshold 15 \
	# --cer-threshold 0.1 \
