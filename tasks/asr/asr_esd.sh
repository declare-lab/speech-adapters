...
CUDA_VISIBLE_DEVICES=2,3 python asr.py \
		--output_dir '/data/yingting/output_earlystop_asr_lora_2e3' \
		--do_train False \
		--do_eval False \
		--do_predict True \
		--evaluation_strategy "steps" \
		...
		--warmup_ratio 0.1 \
		--logging_steps 20 \
		--logging_dir '/data/yingting/output_earlystop_asr_lora_2e3/log' \
		--load_best_model_at_end True \
		--metric_for_best_model "wer" \
		--greater_is_better False
...
# CUDA_VISIBLE_DEVICES=2,3 python asr.py \
# 		--output_dir '/data/yingting/output_earlystop_asr_adapterblock_2e4' \
# 		--do_train False \
# 		--do_eval False \
# 		--do_predict True \
# 		--evaluation_strategy "steps" \
...
# 		--warmup_ratio 0.1 \
# 		--logging_steps 20 \
# 		--logging_dir '/data/yingting/output_earlystop_asr_adapterblock_2e4/log' \
# 		--load_best_model_at_end True \
# 		--metric_for_best_model "wer" \
# 		--greater_is_better False
